import { getMaterialDefaultProps, getMaterialRenderFun } from "@/mock/data";
import { defineStore } from "pinia";
import { computed, ref } from "vue";
import { IMaterial, IProject, PageElement, Project } from "@lcd1024/shared";
...
export const useProjectStore = defineStore("project", () => {
  ...
  const currentPageElementsLength = computed(
    () => project.value.pages[currentPageIndex.value].elements.length
  );
